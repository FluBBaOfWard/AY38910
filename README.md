...
First alloc chip struct, call reset then set in/out function pointers. Call
AY38910Mixer with length, destination and chip struct. Length is the number of
produced samples, this is the same as emulated clocks if not AY_UPSHIFT is
defined. Produces signed 16bit mono.
